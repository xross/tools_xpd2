...
class Version(object):
    def __init__(
        self, major=0, minor=0, point=0, rtype="release", rnumber=0, version_str=None
    ):
    ...
    def parse_string(self, version_string):
        m = re.match(
            r"(\d*)\.(\d*)\.(\d*)(alpha|beta|rc|)(\d*)_([-\w*])_(\d*)\.(\d*)\.(\d*)(alpha|beta|rc|)(\d*)",
            version_string,
        )
    ...
    def match_modulo_branch_rnumber(self, other):
        return (
            ...
            and self.branch_major == other.branch_major
            and self.branch_minor == other.branch_minor
            and self.branch_point == other.branch_point
