...
def check_makefiles(sandbox, force_creation=False):
    ok = True
    for repo in sandbox.repos:
        ok = ok and check_repo_makefiles(repo, force_creation=force_creation)
    return ok

def check_repo_makefiles(repo, force_creation=False):
